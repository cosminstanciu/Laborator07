...
public interface Constants {
    ...
    final public static String GET_WEB_SERVICE_ADDRESS = "https://macin.cs.pub.ro/~dniculescu/didactic/eim/expr/expr_get.php";
    final public static String POST_WEB_SERVICE_ADDRESS = "https://macin.cs.pub.ro/~dniculescu/didactic/eim/expr/expr_post.php";
